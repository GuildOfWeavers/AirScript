...
class BinaryOperation extends Expression_1.Expression {
    ...
    static add(lhs, rhs) {
        ...
        const degree = degree_1.getDegree(lhs, rhs.degree, degree_1.maxDegree);
    ...
    static mul(lhs, rhs) {
        ...
        const degree = degree_1.getDegree(lhs, rhs.degree, degree_1.addDegree);
    ...
    static div(lhs, rhs) {
        ...
        const degree = degree_1.getDegree(lhs, rhs.degree, degree_1.addDegree); // TODO: incorrect
    ...
    static prod(lhs, rhs) {
        ...
        if (lhs.isVector && rhs.isVector) {
            ...
            dimensions = [0, 0];
            degree = degree_1.linearCombinationDegree(lhs.degree, rhs.degree);
        }
            ...
            dimensions = [d1[0], 0];
            degree = degree_1.matrixVectorProductDegree(lhs.degree, lhs.degree);
        }
            ...
            degree = degree_1.matrixMatrixProductDegree(lhs.degree, rhs.degree);
        }
