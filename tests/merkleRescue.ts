...
define MerkleBranch over prime field (2^64 - 21 * 2^30 + 1) {
    ...
    input leaf     : secret[1];     // leaf of the merkle branch
    input node     : secret[1];     // nodes in the merkle branch
    input indexBit : public[1];     // binary representation of leaf position
