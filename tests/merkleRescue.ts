...
define MerkleBranch over prime field (2^64 - 21 * 2^30 + 1) {
    ...
    require 3 input registers {
        secret leaf;                // leaf of the merkle branch
        secret node;                // nodes in the merkle branch
        public binary indexBit;     // binary representation of leaf position
    }
